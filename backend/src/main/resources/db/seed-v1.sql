...
VALUES
    ('系统管理员', 'ADMIN', '系统管理、权限控制与后台维护'),
    ('风控人员', 'RISK_USER', '风险数据录入、评估与预警处理'),
    ('管理人员', 'MANAGER', '预警与统计只读查看')
...
INSERT INTO risk_index (id, index_name, index_code, weight_value, index_desc, status)
VALUES
...
ON DUPLICATE KEY UPDATE
    ...
    index_desc = VALUES(index_desc),
    status = VALUES(status);

INSERT INTO risk_rule (id, index_id, score_min, score_max, score_value, warning_level)
VALUES
...
INSERT INTO risk_data (id, business_no, customer_name, business_type, risk_desc, data_status, create_by, create_time, update_time)
VALUES
...
DELETE FROM risk_data_index_value WHERE risk_data_id IN (1, 2, 3, 4, 5);

INSERT INTO risk_data_index_value (risk_data_id, index_id, index_value)
VALUES
...
INSERT INTO risk_assessment (id, risk_data_id, total_score, risk_level, assessment_status, assessment_time, assessment_by)
VALUES
...
ON DUPLICATE KEY UPDATE
    ...
    assessment_time = VALUES(assessment_time),
    assessment_by = VALUES(assessment_by);

DELETE FROM risk_assessment_index_result WHERE assessment_id IN (1, 2, 3, 4);
...
INSERT INTO risk_warning (id, assessment_id, warning_code, warning_level, warning_content, warning_status, create_time)
VALUES
...
ON DUPLICATE KEY UPDATE
    ...
    warning_level = VALUES(warning_level),
    warning_content = VALUES(warning_content),
    warning_status = VALUES(warning_status),
    create_time = VALUES(create_time);

DELETE FROM warning_handle_record WHERE warning_id IN (1, 2);

INSERT INTO warning_handle_record (id, warning_id, handle_user_id, handle_opinion, handle_result, next_status, handle_time)
VALUES
